...
export type XFormWrapperYupSchemaProvider<TData extends XFormData> = Merge<typeof Yup, {
  objectOf<
...
/** 表单属性 */
export type XFormProps<TData extends XFormData> = Merge<FormProps, {
  onDataChange?(payload: {
    changedData: DeepPartial<TData>,
    data: TData,
    isChanged<TPath extends Path<DeepRequired<TData>, TPath>>(path: TPath): boolean,
  }): any,
}>
...
export type XFormItemProps<TPath, TValue> = Merge<FormItemProps, {
  name?: TPath,
...
export type XFormConditionItemProps<TData extends XFormData> = Merge<FormItemProps, {
...
export interface XFormWrapperChildrenProps<TData extends XFormData> {
  ...
  FormItem<
    TPath extends Path<DeepRequired<TData>, TPath>,
    TValue extends PathValue<DeepRequired<TData>, TPath>
  >(props: XFormItemProps<TPath, TValue>): React.ReactElement,
